# Module: groupC.py
# Purpose: To get the group stage C matches
...
tokens=[
    'BEGINSTAGEC', 'BEGINSTAGED', 'OPENMATCHDIV',
...
def p_start(p):
    '''start : before BEGINSTAGEC skip OPENPOINTTABLE handletable CLOSEPOINTTABLE skip SEPARATOR handlematches BEGINSTAGED'''
    ...
    groupCdata = {
        ...
        'matches' : {
            ...
            '3': {
                ...
                'scorers' : [scorerlist[3],scorerlist[4]]
            },
            '4': {
                'score' : matchlist[3],
