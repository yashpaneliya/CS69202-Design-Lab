# Module: semifinals.py
# module to build lexer and parser for semifinal match
...
def t_CLOSESEMI(t):
    """<span\sclass="mw-headline"\sid="Third_place_play-off">Third\splace\splay\-off</span>"""
    return t
...
# grammar to find semifinal stage in the html file
def p_start(p):
    """start : before OPENSEMI skip SEPARATOR handlematches CLOSESEMI"""
...
def semiFinals():
    ...
    semifinalData = {
        ...
        "2": {
            ...
            "scorerlist": [scorerlist[2], scorerlist[3]],
            "isPen": False,
            "penscorers": [],
        },
    }
