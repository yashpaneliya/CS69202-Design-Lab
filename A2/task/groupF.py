# Module: groupF.py
# Purpose: To get the group stage F matches
...
def p_start(p):
    '''start : before BEGINSTAGEF skip OPENPOINTTABLE handletable CLOSEPOINTTABLE skip SEPARATOR handlematches BEGINSTAGEG'''
