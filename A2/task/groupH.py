# Module: groupH.py
# Purpose: To get the group stage H matches
...
tokens=[
    'BEGINSTAGEH', 'ENDSTAGE', 'OPENMATCHDIV',
...
def p_start(p):
    '''start : before BEGINSTAGEH skip OPENPOINTTABLE handletable CLOSEPOINTTABLE skip SEPARATOR handlematches ENDSTAGE'''
    ...
    groupHdata = {
        ...
        'matches' : {
            ...
            '2': {
                ...
                'scorers' : [scorerlist[0],scorerlist[1],scorerlist[2],scorerlist[3],scorerlist[4]]
            },
            '3': {
                'score' : matchlist[2],
                'details' : matchdetails[2],
                'scorers' : [scorerlist[5],scorerlist[6],scorerlist[7]]
            },
            '4': {
                'score' : matchlist[3],
            ...
            '5': {
                ...
                'scorers' : [scorerlist[9]]
            },
            '6': {
                'score' : matchlist[5],
                'details' : matchdetails[5],
                'scorers' : [scorerlist[10],scorerlist[11],scorerlist[12]]
            }
        }
    }
    f.close()
