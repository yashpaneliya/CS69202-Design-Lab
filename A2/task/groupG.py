# Module: groupG.py
# Purpose: To get the group stage G matches
...
tokens=[
    'BEGINSTAGEG', 'BEGINSTAGEH', 'OPENMATCHDIV',
...
def p_start(p):
    '''start : before BEGINSTAGEG skip OPENPOINTTABLE handletable CLOSEPOINTTABLE skip SEPARATOR handlematches BEGINSTAGEH'''
    ...
    groupGdata = {
        ...
        'matches' : {
            ...
            '2': {
                ...
                'scorers' : [scorerlist[1]]
            },
            '3': {
                'score' : matchlist[2],
                'details' : matchdetails[2],
                'scorers' : [scorerlist[2],scorerlist[3],scorerlist[4],scorerlist[5],scorerlist[6],scorerlist[7]]
            },
            '4': {
                'score' : matchlist[3],
            ...
            '5': {
                ...
                'scorers' : [scorerlist[9],scorerlist[10],scorerlist[11],scorerlist[12],scorerlist[13]]
            },
            '6': {
                'score' : matchlist[5],
                'details' : matchdetails[5],
                'scorers' : [scorerlist[14]]
            }
        }
    }
    f.close()
